"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[5516],{42052:($e,N,s)=>{s.r(N),s.d(N,{MarketPlacePage:()=>je,default:()=>sa});var e=s(32735),v=s(5636),A=s(99357),I=s(58469),m=s(88425),S=s(96709),B=s(17e3),j=s(27649),h=s(61774),p=s(62345),P=s(94638),M=s(88860),b=s(36320),Ve=s(35540),z=s(39291),$=s(3653),ae=s(60216),r=s.n(ae),C=s(99140),Ze=s(54725),x=s(83292);const ne=x.default.div`
  display: grid;
