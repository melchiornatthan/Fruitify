...
import { TextareaInput as $ } from "./TextareaInput.js";
...
`, n = a.forwardRef(
  (_, E) => {
    ...
    return /* @__PURE__ */ a.createElement(P, null, /* @__PURE__ */ a.createElement(y, {
      name: e,
      hint: t,
      error: r,
      id: T
      ...
      spacing: 1
    }, o && /* @__PURE__ */ a.createElement(I, null, /* @__PURE__ */ a.createElement(F, {
      required: v,
      action: u
    }, o)), /* @__PURE__ */ a.createElement($, s({
      ref: E,
      as: "textarea",
      value: h
    }, x)), /* @__PURE__ */ a.createElement(w, null), /* @__PURE__ */ a.createElement(O, null))));
  }
);
