"use strict";var T=Object.defineProperty;var d=Object.getOwnPropertySymbols;var c=Object.prototype.hasOwnProperty,f=Object.prototype.propertyIsEnumerable;var s=(e,l,t)=>l in e?T(e,l,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[l]=t,p=(e,l)=>{for(var t in l||(l={}))c.call(l,t)&&s(e,t,l[t]);if(d)for(var t of d(l))f.call(l,t)&&s(e,t,l[t]);return e};var F=(e,l)=>{var t={};for(var a in e)c.call(e,a)&&l.indexOf(a)<0&&(t[a]=e[a]);if(e!=null&&d)for(var a of d(e))l.indexOf(a)<0&&f.call(e,a)&&(t[a]=e[a]);return t};Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});const b=require("react"),v=require("prop-types"),E=require("../Field/Field.cjs"),_=require("../Field/FieldLabel.cjs");require("../Field/FieldInput.cjs");const I=require("../Field/FieldHint.cjs"),S=require("../Field/FieldError.cjs");require("../Field/FieldContext.cjs");require("../Field/FieldAction.cjs");const O=require("./TextareaInput.cjs"),k=require("../Stack/Stack.cjs"),w=require("../Flex/Flex.cjs"),L=require("styled-components"),P=require("../helpers/useId.cjs"),u=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},i=u(b),r=u(v),R=u(L),$=R.default.div`
  & textarea {
