...
var h = (r, e, o) => e in r ? x(r, e, { enumerable: !0, configurable: !0, writable: !0, value: o }) : r[e] = o, d = (r, e) => {
  for (var o in e || (e = {}))
    v.call(e, o) && h(r, o, e[o]);
  if (i)
    for (var o of i(e))
      y.call(e, o) && h(r, o, e[o]);
  return r;
}, c = (r, e) => C(r, T(e));
var k = (r, e) => {
  var o = {};
...
`, f = a.forwardRef(
  (q, $) => {
    var m = q, { label: r, noBorder: e, children: o, icon: l, disabled: t, onClick: p, ["aria-label"]: R } = m, b = k(m, ["label", "noBorder", "children", "icon", "disabled", "onClick", "aria-label"]);
    const g = (w) => {
      !t && p && p(w);
    };
...
const s = (r, e) => (o, l) => {
  if (!o[l] && r.every((t) => !o[t]))
    return new Error(`One of the following props is required: ${l}, ${r.join(", ")}`);
  n.checkPropTypes({ [l]: n[e] }, o, "prop", "IconButton");
};
f.propTypes = {
