...
import k from "@strapi/icons/ExternalLink";
...
`, l = g(R)`
  display: flex;
`, s = (w) => {
  var c = w, { href: e, to: r, children: o, disabled: t, startIcon: d, endIcon: m } = c, E = y(c, ["href", "to", "children", "disabled", "startIcon", "endIcon"]);
  ...
  return /* @__PURE__ */ n.createElement(_, v({
    ...
    href: t ? "#" : e,
    disabled: t
  }, E), d && /* @__PURE__ */ n.createElement(l, {
    as: "span",
    "aria-hidden": !0,
    paddingRight: 2
  }, d), /* @__PURE__ */ n.createElement(h, null, o), m && !e && /* @__PURE__ */ n.createElement(l, {
    as: "span",
    "aria-hidden": !0,
    paddingLeft: 2
    ...
    "aria-hidden": !0,
    paddingLeft: 2
  }, /* @__PURE__ */ n.createElement(k, null)));
};
s.displayName = "Link";
s.defaultProps = {
  href: void 0,
