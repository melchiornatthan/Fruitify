...
const E = ({
  ...
  const [o, m] = L(g), [u, C, T] = N(o, i), { sun: M, mon: O, tue: P, wed: b, thu: x, fri: q, sat: v } = J(), c = K(), F = Q(w, R);
  W(() => {
    i && m(i);
  }, [i]);
  const Y = (t) => {
  ...
  return /* @__PURE__ */ e.createElement(H, {
    ...
    "aria-rowindex": 1
  }, /* @__PURE__ */ e.createElement(r, null, M), /* @__PURE__ */ e.createElement(r, null, O), /* @__PURE__ */ e.createElement(r, null, P), /* @__PURE__ */ e.createElement(r, null, b), /* @__PURE__ */ e.createElement(r, null, x), /* @__PURE__ */ e.createElement(r, null, q), /* @__PURE__ */ e.createElement(r, null, v))), /* @__PURE__ */ e.createElement(z, null, u.map((t, n) => /* @__PURE__ */ e.createElement(d, {
    key: `week-${n}`
  }, t.map(({ date: l, outsideMonth: $, isSelected: B }) => /* @__PURE__ */ e.createElement(A, {
    key: `${l.getFullYear()}-${l.getMonth() + 1}-${l.getDate()}`,
    outsideMonth: $,
    onSelectDay: () => h(l),
    isSelected: B
  }, /* @__PURE__ */ e.createElement("span", {
    "aria-hidden": !0
  }, l.getDate()), /* @__PURE__ */ e.createElement(_, null, /* @__PURE__ */ e.createElement("span", null, U(l))))))))))));
};
E.defaultProps = { selectedDate: void 0, initialDate: new Date() };
E.propTypes = {
