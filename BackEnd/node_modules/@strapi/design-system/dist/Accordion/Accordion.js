...
const b = ({ theme: r, expanded: e, variant: t, disabled: d, error: i }) => i ? `1px solid ${r.colors.danger600} !important` : d ? `1px solid ${r.colors.neutral150}` : e ? `1px solid ${r.colors.primary600}` : t === "primary" ? `1px solid ${r.colors.neutral0}` : `1px solid ${r.colors.neutral100}`, T = p(l)``, E = p(c)`
  border: ${b};
...
`, m = ({
  ...
  return /* @__PURE__ */ a.createElement($.Provider, {
    value: { expanded: e, onToggle: u, toggle: f, id: y, size: d, variant: i, disabled: n }
    ...
    variant: i,
    error: s
  }, r), s && g && /* @__PURE__ */ a.createElement(c, {
    paddingTop: 1
