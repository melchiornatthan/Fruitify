...
const R = (P) => {
  var a = P, { children: e, labelledBy: o, onChange: r, value: i, size: g, name: s } = a, y = m(a, ["children", "labelledBy", "onChange", "value", "size", "name"]);
  const d = q(null);
  return v(() => {
    i || E(d.current, `[name="${s}"]`);
  }, [i]), /* @__PURE__ */ c.createElement(x.Provider, {
